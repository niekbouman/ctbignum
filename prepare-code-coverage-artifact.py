...
# This script was retrieved from the LLVM repo:
# https://github.com/llvm/llvm-project/blob/main/llvm/utils/prepare-code-coverage-artifact.py
...
def prepare_html_report(
    ...
    invocation = (
        ...
        + [
            ...
            # "-show-directory-coverage", # disabled because only available in newer builds of llvm-cov
            "-Xdemangler",
            "c++filt",
            "-Xdemangler",
            "-n",
